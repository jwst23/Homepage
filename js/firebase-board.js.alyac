...
if (writeForm) {
    writeForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            alert('게시글 등록에 실패했습니다. Firebase Config를 확인하세요.');
        } finally {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (firebaseConfig.apiKey !== "YOUR_API_KEY") {
        ...
        postList.innerHTML = '<li class="post-item" style="color:#d9534f">Firebase API Key가 설정되지 않았습니다. js/firebase-board.js 파일을 수정해주세요.</li>';
    }
});
